...
<head>
    <meta charset="UTF-8">
    <title>Add Customer | Dudhauli Nishan Cable T.V Network</title>
            ...
            <div class="sales-boxes">
                <div class="recent-sales box">
                    ...
                    <div class="sales-details">
                        <!-- form -->
                        <form action="backend/add-customer.php" method="post">
                            ...
                            <div class="single-row">
                                ...
                                <div class="input-area">
                                    ...
                                    <input type="number" placeholder="Enter Mobile no." name="mobile" autocomplete="off">
                                </div>
                            </div>
